...
const TRIGGER_CATALOG = [
    ...
    // culturalNote actualizado 2026-05-14 v2 tras review cruzada de Z/GLM-4
    // (Hallazgos #3-#10 del review postmortem de PR #7).
    // CRÍTICO: el culturalNote anterior de `ok` decía "IDEAL para monetización"
    // por error de interpretación. Corregido a "DO NOT use for monetization in CJK"
    // siguiendo la propuesta exacta de Z en CULTURAL_GESTURE_REVIEW.md §5.
    { key: 'thumbs-up',  category: 'hand',     universal: false, icon: '👍',  i18n: 'scenes.thumbs_up',  requires: 'hand', culturalNote: 'Middle East / West Asia / Iran / Afghanistan: highly offensive (equivalent to middle finger). West / Latin America: approval/good. China / Japan / Korea / Taiwan: approval/good — widely used and adopted (微信 👍 / いいね). Japanese streamers prefer 🙏 gassho for donation thanks. Safe default for CJK markets.' },
    ...
    { key: 'rock',       category: 'hand',     universal: false, icon: '🤘',  i18n: 'scenes.rock',       requires: 'hand', culturalNote: 'Italy / Spain / parts of LatAm: palm down = "cornuto" (cuckold insult). Palm up = rock/metal. China / Korea / Japan: no negative meaning — recognized as rock/metal sign by younger audiences, unfamiliar to some older users. Not offensive in any CJK culture.' },
    { key: 'ok',         category: 'hand',     universal: false, icon: '👌',  i18n: 'scenes.ok',         requires: 'hand', culturalNote: 'Brazil / Turkey / Germany / France: offensive (vulgar). USA / UK: OK / approval. Japan / Korea / Taiwan: means MONEY / COIN (お金 / 돈), NOT "OK". Korea: also associated with political extremism (Ilbe 일베) since 2019 — HIGH RISK. China: means coin / money, sometimes vulgar. Use thumbs-up instead for "OK" in CJK markets. DO NOT use for monetization triggers in CJK.' },
    { key: 'fist',       category: 'hand',     universal: false, icon: '✊',  i18n: 'scenes.fist',       requires: 'hand', culturalNote: 'Political meaning varies by context. China: raised fist = Communist revolution symbolism (caution in formal contexts). Korea: "fighting" (파이팅) fist is positive, but also used in political protests. Japan: "fight" (ファイト) fist is positive, less political. Taiwan: democracy movement symbolism. In streaming / casual contexts across CJK, the "fighting spirit" meaning is dominant.' },
    { key: 'open-palm',  category: 'hand',     universal: false, icon: '🖐️',  i18n: 'scenes.open_palm',  requires: 'hand', culturalNote: 'Greece (mountza): open palm toward someone = severe insult. Korea: open palm toward face = EQUIVALENT TO MIDDLE FINGER (손바닥) — extremely offensive. China / Taiwan: "stop" or "five", can be rude toward face. Japan: standard "stop" signal, generally safe. Most of world: "stop" or "high-five". DISABLE BY DEFAULT for Korean locale.' },
    { key: 'point',      category: 'hand',     universal: false, icon: '☝️',  i18n: 'scenes.point',      requires: 'hand', culturalNote: 'EXTREMELY offensive in China / Korea / Japan / Taiwan / Singapore — pointing at a person with the index finger is one of the most basic etiquette violations in all CJK cultures (taught to children from age 2-3). Equivalent to or worse than verbal insult. Always use the whole hand (palm up) to indicate people in CJK cultures. West: generally acceptable to point at objects, rude to point at people. Middle East / Malaysia / Indonesia: also offensive. NO monetization triggers. DISABLE BY DEFAULT for CJK locales.' },

    // 🙏 Gassho — TASK-208 aprobado Joel 2026-05-14
    // Detección via core/gesture-gassho.js (heurística landmarks Human.js, ~85% accuracy)
    { key: 'gassho',     category: 'hand',     universal: false, icon: '🙏',  i18n: 'scenes.gassho',     requires: 'hand', culturalNote: 'Japan / China / Taiwan / Korea: THE courtesy gesture — means "thank you", "please", "sorry" and respect (合掌 / 합장 / 合十). PERFECT for donation thanks / sub / super chat triggers in Asian markets. Thailand / Vietnam / Laos: primary greeting gesture (wai / ไหว้). India / Nepal: namaste. West: religious / prayer context — may not be understood as "thank you" by default.' }
];
