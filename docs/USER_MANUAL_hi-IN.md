...
> **ईमानदार इशारे।** अपने चेहरे और हाथों से अपने स्ट्रीमिंग सॉफ़्टवेयर को नियंत्रित करें। स्ट्रीम डेक की आवश्यकता नहीं। किसी अतिरिक्त हार्डवेयर की आवश्यकता नहीं।

**संस्करण**: 3.0 · **भाषा**: हिंदी (12 अन्य भाषाओं में अनुवाद उपलब्ध)
...
EsperantAI एक **वेब ऐप** है जो कृत्रिम बुद्धिमत्ता का उपयोग करके आपके चेहरे और हाथों के इशारों को वास्तविक समय में पहचानता है, और उन्हें आपके स्ट्रीमिंग सॉफ़्टवेयर के लिए कमांड में अनुवादित करता है। यह निम्नलिखित के साथ काम करता है:

- **OBS Studio** 28+
- **Streamlabs Desktop**
- **vMix**
- **PRISM Live Studio**
- **XSplit Broadcaster** (बीटा)

और निम्नलिखित प्लेटफ़ॉर्म से इवेंट प्राप्त करता है:
...
1. **https://esperantai.com** पर जाएँ
...
1. PRISM Live Studio v4.0.5+ के लिए obs-websocket प्लगइन的手动 स्थापना आवश्यक है
2. [OBS फ़ोरम](https://obsproject.com/forum/resources/obs-websocket-remote-control-of-obs-studio-made-easy.466/) से `obs-websocket` डाउनलोड करें
3. PRISM के प्लगइन फ़ोल्डर में कॉपी करें
...
1. XSplit में "Remote xjs" एक्सटेंशन स्थापित करें (Settings → Extensions)
2. प्राथमिकताओं में Remote सक्षम करें
3. EsperantAI में: स्ट्रीमिंग सॉफ़्टवेयर: **XSplit**
4. Remote xjs Proxy URL: `ws://127.0.0.1:5555/xjs` (डिफ़ॉल्ट)
5. **कनेक्ट** पर क्लिक करें

> XSplit **बीटा** में है। उन्नत सुविधाएँ सीमित हो सकती हैं।
...
EsperantAI को इवेंट (दान, सब्सक्रिप्शन, रेड) प्राप्त करने के लिए, उन प्लेटफ़ॉर्म को कनेक्ट करें जहाँ आप स्ट्रीम करते हैं।

### Twitch

1. https://dev.twitch.tv/console पर Client ID बनाएँ
2. रीडायरेक्ट URI पंजीकृत करें: `https://esperantai.com/oauth-callback.html` (या अपना स्थानीय URL)
...
1. https://kick.com/settings/developer पर ऐप बनाएँ
2. रीडायरेक्ट URI पंजीकृत करें
3. EsperantAI में: **प्लेटफ़ॉर्म इवेंट** पैनल → **Kick**
4. अपना Client ID पेस्ट करें और **कनेक्ट** पर क्लिक करें
5. Kick OAuth 2.1 with PKCE का उपयोग करता है (अधिक सुरक्षित)

### StreamElements (मल्टी-प्लेटफ़ॉर्म ब्रिज)

यदि आपके पास पहले से StreamElements खाता है, तो आप एक ही टोकन से Twitch + YouTube + Facebook को एकीकृत कर सकते हैं:
...
सभी 15 भाषाएँ पूरी तरह अनुवादित हैं।
...
यदि EsperantAI आपकी अपेक्षाओं पर खरा नहीं उतरता, तो आपके पास खरीद से **14 दिन** के भीतर पूर्ण रिफंड का अधिकार है। अपनी लाइसेंस कुंजी के साथ soporte@edugame.digital पर ईमेल करें।
...
- ✅ आपके OBS / Streamlabs / vMix के लिए स्थानीय कनेक्शन (loopback 127.0.0.1)
- ✅ आवधिक लाइसेंस कुंजी सत्यापन (हर 7 दिन)
- ✅ यदि आप Twitch/YouTube/Kick कनेक्ट करते हैं: sessionStorage में OAuth टोकन (ब्राउज़र बंद होने पर हट जाते हैं)
...
- 🌐 वेब: https://esperantai.com
- 📚 तकनीकी दस्तावेज़: https://github.com/salazarjoelo/EsperantAI

प्रतिक्रिया समय:
- सामान्य प्रश्न: 24-72 घंटे
- तकनीकी त्रुटियाँ: 1-3 कार्य दिवस
- रिफंड अनुरोध: 1-2 कार्य दिवस

---

*अंतिम अपडेट: 2026-05-14। संस्करण: 3.0.*
