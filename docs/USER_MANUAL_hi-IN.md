...
**संस्करण**: 3.0 · **भाषा**: हिंदी (14 अन्य भाषाओं में भी अनुवाद उपलब्ध)
...
- **Kick**: ब्राउज़र में beta/limited समर्थन। पूरे Kick इवेंट के लिए आधिकारिक backend/webhooks या bridge चाहिए।
- **StreamElements**: आपके खाते के token/JWT के साथ मल्टी-प्लेटफ़ॉर्म bridge।
- **Trovo**: कोड में technical adapter मौजूद है, लेकिन public UI connection panel अभी expose नहीं है।
...
1. Kick developer portal में application बनाएँ
...
5. Kick OAuth 2.1 with PKCE का उपयोग करता है।

मौजूदा स्थिति: **beta/limited**। Kick की official documentation पूरे events के लिए webhooks का उपयोग करती है। ब्राउज़र में EsperantAI activity का सीमित हिस्सा ही detect कर सकता है; reliable Kick subscriptions, gifts, raids या events के लिए StreamElements जैसा bridge या backend/webhook उपयोग करें।
...
EsperantAI के code में Trovo के लिए OAuth और Trovo WebSocket chat service पर आधारित technical adapter मौजूद है। मौजूदा public UI में Trovo connection panel अभी expose नहीं है, इसलिए इसे सामान्य user flow की तरह document नहीं किया गया है। अगर आपको अभी Trovo चाहिए, तो compatible bridge उपयोग करें या Trovo panel के active होने की प्रतीक्षा करें।
...
### Kick सभी events नहीं दिखाता

Kick ब्राउज़र में beta/limited mode में है। Kick के पूरे events official रूप से webhooks से मिलते हैं; reliable subscriptions, gifts या raids के लिए StreamElements या अपना backend उपयोग करें।
...
*अंतिम अपडेट: 2026-05-20। संस्करण: 3.0.*
